...
{
    uint8_t config = read_register(CONFIG) & (0b11110011);
...
void RF24::setRetries(uint8_t delay, uint8_t count)
{
    ...
    uint8_t shifted_delay = delay << 4;
    uint8_t delay_count = shifted_delay | count;
    write_register(SETUP_RETR, delay_count);
    //TODO: END HERE
}
